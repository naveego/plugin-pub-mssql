...
type ReplicationSettings struct {
	...
	PropertyConfiguration []PropertyConfig `json:"propertyConfig" title:"Custom Property Configuration" description:"Custom configuration of SQL types for properties." required:"false"`
}
